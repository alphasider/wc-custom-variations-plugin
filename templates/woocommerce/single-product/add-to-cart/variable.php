...
<?php echo do_shortcode('[add_to_cart_btn label="Subscribe now" product_id=34]'); ?>
  ...
  <form class="variations_form cart"
    ...
    <?php if (empty($available_variations) && false !== $available_variations) : ?>
      <p
        class="stock out-of-stock"><?php echo esc_html(apply_filters('woocommerce_out_of_stock_message', __('This product is currently out of stock and unavailable.', 'woocommerce'))); ?></p>
    <?php else : ?>
